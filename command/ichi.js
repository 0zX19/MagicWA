...
case 'serverbuilder': case 'sb': {
  let menu2 = `⛩ Server Builder

Build only : 50k
Full Setup : 150k ( Free revisi, request 7 hari )
Perawatan : 100k/bulan`
  let but = [
  {"quickReplyButton": {"displayText": "Donasi 🗂️","id": `donasi`},},
  {"quickReplyButton": {"displayText": "Owner 👦","id": "owner"},},
  {"quickReplyButton": {"displayText": "Status Bot ⌚","id": `ping`}}
  ]
  ichi.sendButtonImg(m.chat, menu2, global.ownerName, global.thumb, but, global.thumb)
  }
  break
